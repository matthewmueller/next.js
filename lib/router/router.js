...
export default class Router {
  ...
  async getRouteInfo(route, pathname, query, as) {
    ...
    try {
      ...
      const ctx = { err, pathname: url.pathname, query, jsonPageRes, as: url.pathname || pathname }
      ...
      const ctx = { err, pathname, query, as: url.pathname || pathname }
      routeInfo.props = await this.getInitialProps(Component, ctx)
